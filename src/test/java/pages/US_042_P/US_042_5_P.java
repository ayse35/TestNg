...
public class US_042_5_P {
    ...
    @FindBy(xpath = "(//p[contains(@class,'my-2.5 font-semibold text-accent')])[1]")//sepeteki ürünün birim fiyat  locate
    public WebElement birimFiyatButton;



   // @FindBy(xpath = "(//p[@class='my-2.5 font-semibold text-accent'])[1]")//sepeteki ürünün birim fiyat  locate
    //public WebElement birimFiyatButton;



    // @FindBy(xpath= "(//span[@class='font-bold text-heading ltr:ml-auto rtl:mr-auto'])[1]") //sepeteki ürünün toplam fiyat  locate
    // public WebElement toplamFiyatButton;

    // @FindBy(xpath= "//span[contains(@class,'flex h-full shrink-0 items-center')]") //sepeteki tüm ürünlerin toplam fiyat-kasadaki--  locate
    // public WebElement kasaToplamFiyatButton;
